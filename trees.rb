...
class Tree  #any time you see attribute ^ that means you need an instance variable. 

  # attr_reader :rings #a short hand for a getter method

  def initialize
    @rings = 0
  end

  def rings #long hand getter method
    @rings
  end

  def bear_fruit? #method with question mark means you are looking for true or false
    if @rings > 7 && @rings < 15
      has_fruit = true
    else
      has_fruit = false
